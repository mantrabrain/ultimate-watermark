...
class Image
{
    public static function get_settings()
    {
        ...
        return array(
            array(
                'title' => __('Watermark Image For Video', 'ultimate-watermark'),
                'type' => 'title',
                'desc' => '',
            ...
            array(
                ...
                'desc_tip' => false,
                'id' => 'ultimate_watermark_video_watermark_image',
                'type' => 'image',
            )
        ,
            array(
                ...
                'desc_tip' => false,
                'id' => 'ultimate_watermark_video_watermark_size_type',
                'options' => array(
            ...
            array(
                ...
                'desc_tip' => false,
                'id' => 'ultimate_watermark_video_absolute_width',
                'default' => 0,
                'type' => 'number',
                'display_conditions' => array(
                    array(
                        'field' => 'ultimate_watermark_video_watermark_size_type',
                        'compare' => '=',
                        'value' => 'custom'
                    )
                )
            ...
            array(
                ...
                'desc_tip' => false,
                'id' => 'ultimate_watermark_video_absolute_height',
                'default' => 0,
                'type' => 'number',
                'display_conditions' => array(
                    array(
            ...
            array(
                ...
                'desc_tip' => false,
                'id' => 'ultimate_watermark_video_scaled_image_width',
                'default' => 80,
                'type' => 'slider',
                'data' => array(
                    'max' => 100,
            ...
            array(
                ...
                'desc_tip' => false,
                'id' => 'ultimate_watermark_video_image_transparent',
                'default' => 50,
                'type' => 'slider',
                'data' => array(
                    'max' => 100,
            ...
            array(
                ...
                'desc_tip' => false,
                'id' => 'ultimate_watermark_video_image_quality',
                'default' => 90,
                'type' => 'slider',
                'data' => array(
                    'max' => 100,
            ...
            array(
                ...
                'desc_tip' => false,
                'id' => 'ultimate_watermark_video_image_format',
                'options' => array(
